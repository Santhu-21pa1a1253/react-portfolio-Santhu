...
import Profile from "../assets/Kprofile.jpg";
import "./Hero.css";
        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            >
              ...
              robust and scalable web applications. I am also a comprehensive
              data analyst with an instance of knowledge on powerBi and SQL. My
